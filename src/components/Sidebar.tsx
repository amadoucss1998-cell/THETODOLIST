                    ...
                    <div className="glass-card rounded-xl p-3 space-y-2.5">
                          ...
                          {CATEGORY_COLORS.map((c) => (
                            <button
                              ...
                              style={{
                                background: c,
                                boxShadow:
                                  catColor === c ? `0 0 0 2px white, 0 0 0 3px ${c}` : 'none',
                              }}
                            />
                          ))}
                        </div>
                        ...
                        <div className="flex gap-1.5 flex-wrap">
                          {CATEGORY_ICONS.map((ic) => (
                            <button
                              ...
                              style={{
                                background:
                                  catIcon === ic ? 'rgba(139,92,246,0.25)' : 'rgba(255,255,255,0.05)',
                                border:
                                  catIcon === ic
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 py-1.5 rounded-lg text-xs font-semibold text-white transition-all disabled:opacity-40"
                          style={{ background: 'linear-gradient(135deg, #7c3aed, #4f46e5)' }}
                        >
                          Add
                        </button>
          ...
          <div className="px-4 py-4 border-t border-white/5">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] text-white/35 leading-tight">Press <kbd className="text-[9px] bg-white/10 px-1 rounded">N</kbd> to add a new task fast</p>
              </div>
            </div>
          </div>
        </div>
